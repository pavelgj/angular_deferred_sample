...
import "package:angular/change_detection/dirty_checking_change_detector.dart" as import_35;
...
import "package:route_hierarchical/client.dart" as import_39;
import "package:angular/angular.dart" as import_1;
import "package:angular/core/parser/lexer.dart" as import_19;
import "package:angular/core/parser/dynamic_parser.dart" as import_40;
import "package:angular/core/parser/static_parser.dart" as import_41;
var typeFactories = {
import_5.Profiler: (f) => new import_5.Profiler(),
import_12.RootScope: (f) => new import_12.RootScope(f(Object), f(import_12.AstParser), f(import_18.Parser), f(import_35.GetterCache), f(import_12.FilterMap), f(import_12.ExceptionHandler), f(import_12.ScopeDigestTTL), f(import_12.NgZone)),
...
import_13.DirectiveMap: (f) => new import_13.DirectiveMap(f(import_10.Injector), f(import_12.MetadataExtractor), f(import_13.FieldMetadataExtractor)),
...
import_14.NgClassDirective: (f) => new import_14.NgClassDirective(f(import_8.Element), f(import_12.Scope), f(import_13.NodeAttrs), f(import_12.AstParser)),
import_14.NgClassOddDirective: (f) => new import_14.NgClassOddDirective(f(import_8.Element), f(import_12.Scope), f(import_13.NodeAttrs), f(import_12.AstParser)),
import_14.NgClassEvenDirective: (f) => new import_14.NgClassEvenDirective(f(import_8.Element), f(import_12.Scope), f(import_13.NodeAttrs), f(import_12.AstParser)),
import_14.NgEventDirective: (f) => new import_14.NgEventDirective(f(import_8.Element), f(import_12.Scope)),
import_14.NgCloakDirective: (f) => new import_14.NgCloakDirective(f(import_8.Element)),
...
import_14.NgModel: (f) => new import_14.NgModel(f(import_12.Scope), f(import_8.Element), f(import_10.Injector), f(import_14.NgForm), f(import_12.AstParser), f(import_13.NodeAttrs)),
...
import_14.NgRepeatDirective: (f) => new import_14.NgRepeatDirective(f(import_13.BlockHole), f(import_13.BoundBlockFactory), f(import_12.Scope), f(import_18.Parser), f(import_12.AstParser)),
import_14.NgShallowRepeatDirective: (f) => new import_14.NgShallowRepeatDirective(f(import_13.BlockHole), f(import_13.BoundBlockFactory), f(import_12.Scope), f(import_18.Parser), f(import_12.AstParser)),
import_14.NgTemplateDirective: (f) => new import_14.NgTemplateDirective(f(import_8.Element), f(import_13.TemplateCache)),
import_14.NgHideDirective: (f) => new import_14.NgHideDirective(f(import_8.Element)),
import_14.NgShowDirective: (f) => new import_14.NgShowDirective(f(import_8.Element)),
...
import_14.NgForm: (f) => new import_14.NgForm(f(import_12.Scope), f(import_8.Element), f(import_10.Injector)),
...
import_17.NgRoutingHelper: (f) => new import_17.NgRoutingHelper(f(import_17.RouteInitializer), f(import_10.Injector), f(import_39.Router), f(import_1.NgApp)),
import_17.NgViewDirective: (f) => new import_17.NgViewDirective(f(import_8.Element), f(import_13.BlockCache), f(import_10.Injector), f(import_39.Router), f(import_12.Scope)),
import_17.NgBindRouteDirective: (f) => new import_17.NgBindRouteDirective(f(import_39.Router), f(import_10.Injector), f(import_17.NgRoutingHelper)),
import_19.Lexer: (f) => new import_19.Lexer(),
import_40.ClosureMap: (f) => new import_40.ClosureMap(),
import_40.DynamicParser: (f) => new import_40.DynamicParser(f(import_19.Lexer), f(import_18.ParserBackend)),
import_40.DynamicParserBackend: (f) => new import_40.DynamicParserBackend(f(import_40.ClosureMap)),
import_41.StaticParser: (f) => new import_41.StaticParser(f(import_41.StaticParserFunctions), f(import_40.DynamicParser)),
